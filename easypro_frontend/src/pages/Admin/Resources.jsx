...
import ConfirmDeleteModal from '../../components/Admin/Resource/ConfirmDeleteModal';
...
const Resources = () => {
	...
	const handelDeleteResource = async () => {
		setDeleteLoading(true);
		try {
			const response = await axios.delete(`${API_URL}/resource/${selectedResource._id}`, {
				headers: {
	...
	return (
		<div>
										...
										<div className="relative h-48 bg-gray-100">
											...
											<div className="flex gap-2 absolute top-2 right-2">
												...
												<div
													...
													className="bg-red-100 hover:bg-red-400 text-red-500 hover:text-white rounded-full p-1 cursor-pointer"
												>
													<Trash2 size={18} />
												</div>
											</div>
			...
			<ConfirmDeleteModal
				...
				onConfirm={handelDeleteResource}
			/>
		</div>
	);
};
