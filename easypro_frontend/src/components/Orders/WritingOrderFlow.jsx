import { ChevronLeft, ChevronRight, Presentation, Upload } from 'lucide-react';
import { useEffect } from 'react';
import { toast } from 'react-toastify';
import { useNavigate } from 'react-router-dom';
import Counter from './Counter';

const WritingOrderFlow = ({
	currentStep,
	orderData,
	updateOrderData,
	nextStep,
				...
				return (
					<div className="space-y-6">
						...
						<div className="flex justify-between pt-4 text-sm md:text-base">
							...
							<button
								onClick={nextStep}
								disabled={!orderData.paperType || !orderData.subject ||
...
export default WritingOrderFlow;